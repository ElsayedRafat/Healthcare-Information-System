        ...
        <div class="container" id="container">
            ...
            <div class="form-container sign-in-container">
                <form role="form" method="post" action="#" >
                    ...
                    <a href="drrecovery.php">Forgot your password?</a>
                    <button class="btn btn-lg btn-success btn-block" type="submit" value="login" name="logind" >Sign in</button>
                </form>
            </div>
...
{  
    ...
    $check_user="SELECT * FROM dr WHERE email='$user_email' AND password='$user_pass'";  
  
    $run=mysqli_query($con,$check_user);  
  
    if(mysqli_num_rows($run))  
    {  
        echo "<script>window.open('dashboarddr.html','_self')</script>";  
      ...
      echo "<script>alert('Email or password is incorrect!')</script>";  
        ...
        if(isset($_POST['btnsignup'])){
           ...
           if($isValid){
             ...
             $stmt = $con->prepare("SELECT * FROM dr WHERE email = ?");
           ...
           // Insert records
           if($isValid){
             $insertSQL = "INSERT INTO dr(username,email,password ) values(?,?,?)";
